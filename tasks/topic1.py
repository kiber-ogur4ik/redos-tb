...
"""), utils.task_check_widget("1-1"), Markdown("""
## Задание 1.2
Сгенерируйте ключи SSH для пользователя user. Это позволит вам безопасно подключаться к серверу без ввода пароля.
"""), utils.task_check_widget("1-2"), Markdown("""
## Задание 1.3
Отключите доступ к серверу по паролю. Это не позволит злоумышленникам подобрать пароль и войти на сервер. 
"""), utils.task_check_widget("1-3"), Markdown("""       
## Заключение
