...
""",
            ...
            Markdown(
                """
## Задание 5.6
Пройдите первоначальную настройку Gitea на localhost:3000, используя в качестве параметров базы данных параметры, которые вы использовали при настройке PostgreSQL.
""",
            ),
